...
TEXTURE2D(_BakedLightMap);
SAMPLER(sampler_BakedLightMap);
...
inline void InitializeStandardLitSurfaceData(float2 uv, out SurfaceData outSurfaceData)
{
    ...
    #ifdef _Colored
    outSurfaceData.albedo = albedoAlpha.rgb * (albedoAlpha.a) + _BaseColor.rgb * (1 - albedoAlpha.a);
    //albedoAlpha.rgb*(mask)+(1-mask);
    outSurfaceData.albedo = saturate(outSurfaceData.albedo);
    #else
    ...
    outSurfaceData.occlusion = albedoAlpha.a; //SampleOcclusion(uv);
