...
namespace Elex.SDFShadowMask.Editor
{
    public class RendererData
    {
        ...
        internal static void Write(SerializedProperty property, RendererData value)
        {
            ...
            //property.FindPropertyRelative("m_FileID").stringValue                 = value.fileID;
            //property.FindPropertyRelative("m_PathID").stringValue                 = value.pathID;
        ...
        internal static RendererData Read(SerializedProperty property)
        {
            return new RendererData
            {
                ...
                //fileID                  = property.FindPropertyRelative("m_FileID").stringValue,
                //pathID                  = property.FindPropertyRelative("m_PathID").stringValue,
