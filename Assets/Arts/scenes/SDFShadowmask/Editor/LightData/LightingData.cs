...
namespace Elex.SDFShadowMask.Editor
{
    public class LightingData
    {
        ...
        public void CheckLightmappedRendererData()
        {
            if(m_LightmappedRendererData != null)
            {
                var test = m_LightmappedRendererData;
                var hasnext = test.Next(true);
                while(hasnext)
                {
                    Debug.Log(test.name);
                    hasnext = test.Next(true);
                    //if(test.name == "m_FileID")
                    //{
                    //    Debug.Log(test.intValue);
                    //    Debug.Log(test.stringValue);
                    //    Debug.Log(test.longValue);
                    //    Debug.Log(test.floatValue);
                    //    Debug.Log(test.objectReferenceValue);
                    //    Debug.Log(test.managedReferenceFullTypename);
                    //}
                    if (test.name == "m_PathID")
                    {
                        //Debug.Log(test.intValue);
                        //Debug.Log(test.stringValue);
                        Debug.Log(test.longValue);
