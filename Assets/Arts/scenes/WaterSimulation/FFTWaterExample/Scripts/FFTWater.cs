...
public class FFTWater : MonoBehaviour {
    ...
    [Header("Debug Tools")] 
    public GameObject initialSpectrumTexturesContainer;
    ...
    void Update() {
        ...
        initialSpectrumTexturesContainer.GetComponent<MeshRenderer>().material.SetTexture("_MainTex", spectrumTextures);
        // Assemble maps
