...
{
    public class MaterialUIClean : ShaderGUI
    {
#if URP
        ...
        private MaterialProperty _DeepColor1;
        ...
        private UI.Material.Section depthSection;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            _DeepColor1 = FindProperty("_DeepColor1", props);
        ...
        private void OnEnable()
        {
            ...
            reflectionSection = new UI.Material.Section(materialEditor,"REFLECTIONS", new GUIContent("Reflections——— 高光、天空盒反射（相机较为平的时候能看到）", "Sun specular reflection, and environment reflections (reflection probes and planar reflections)"));
            ...
            depthSection = new UI.Material.Section(materialEditor,"Depth", new GUIContent("DepthControl ———— 控制深度和深浅", "Parametric gerstner waves, which modify the surface curvature and animate the mesh's vertices"));
        ...
        private void ApplyChanges()
        {
            ...
            //CoreUtils.SetKeyword(targetMat, "_DISTANCE_NORMALS", false);
        ...
        private void DrawLighting()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(lightingSection.anim.faded))
            {
                ...
                {
                    EditorGUILayout.LabelField("Sparkles---法线产生的浪花", EditorStyles.boldLabel);
        ...
        private void DrawColor()
        {
            ...
            if (EditorGUILayout.BeginFadeGroup(colorSection.anim.faded))
            {
                ...
                UI.Material.DrawColorField(_DeepColor1, true, _DeepColor1.displayName, "Water color in shallow areas, alpha channel controls transparency. Note that the caustics effect is visible here, setting the alpha to 100% hides caustics");
        ...
        private void DrawDepthControl()
        {
            depthSection.DrawHeader(() => SwitchSection(depthSection));
            
            if (EditorGUILayout.BeginFadeGroup(depthSection.anim.faded))
            {
                 EditorGUILayout.Space();
        ...
        private void SwitchSection(UI.Material.Section s)
        {
            ...
            depthSection.Expanded = (s == depthSection) && !depthSection.Expanded;
